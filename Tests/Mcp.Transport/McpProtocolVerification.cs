...
internal static class McpProtocolVerification
{
    public static async Task RunAsync()
    {
        ...
        if(tools.Count!=20 || !tools.Any(t=>t.Name=="forge_apply") || !tools.Any(t=>t.Name=="forge_get_state") || !tools.Any(t=>t.Name=="forge_capabilities") || !tools.Any(t=>t.Name=="forge_graph_inspect") || !tools.Any(t=>t.Name=="forge_validate") || !tools.Any(t=>t.Name=="forge_export_glb") || !tools.Any(t=>t.Name=="forge_surface_fit_inspect") || !tools.Any(t=>t.Name=="forge_secondary_motion_state") || !tools.Any(t=>t.Name=="forge_secondary_motion_step") || !tools.Any(t=>t.Name=="forge_secondary_motion_capture")) throw new Exception("Unexpected MCP tool registry");
