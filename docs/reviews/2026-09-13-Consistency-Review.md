...
The material panel no longer says that material-enabled Unity output is still in development. It now explains that the authored material can be saved and exported through the supported Unity profiles. Windows Player `Builds/MaterialMessagingV1/NyaForge.exe` passed the 800x600 Authoring suite with **78 checks** (`Artifacts/Authoring-20260913-090623-889afe772a2a44dba831a8fab5c80adf/report.json`).

# 2026-09-13 authoring validation skin capacity

The read-only output check now reports evaluated skin capacity for skinned graphs. It derives bone count and maximum per-vertex influence from output-reachable `SkeletonOutputs` and `SkinBindingOutputs`, checks them against the NyaForge authoring capacities of 512 bones and 32 influences, excludes disconnected work-in-progress rigs, and shows `actual/limit` in the GUI. Static graphs and avatar fit remain `unknown` where the evidence is unavailable. Core passed **464 / 0** (`C:/Users/tomoaki/AppData/Local/Temp/NyaForge-Core-Tests-bce4bb3011f945c48f007146f1832ddf`). Windows Player `Builds/ValidationSkinV3/NyaForge.exe` passed the 800x600 Authoring suite with **78 checks** (`Artifacts/Authoring-20260913-090034-98ebf69a86954db2a008d2d70b6d785e/report.json`), and the Unity **2022.3.22f1** synthetic Bridge receiver passed (`Artifacts/BridgeReceiver-20260913-090105-766-345e4b00828e4a0e8926294900142ae7/bridge-report.json`). The same ValidationSkinV3 Player also passed a private temporary RadDollV3 VRM smoke for candidate selection, EditMesh vertex editing, native Save/Open, standard skinned GLB output, and re-import (`Artifacts/Authoring-20260913-090318-0e84c8ce478a4d03b9f76660af3b2802/report.json`); its Unity **2022.3.22f1** synthetic Bridge passed at `Artifacts/BridgeReceiver-20260913-090435-743-a95c669a3bad4760a2d6f6bd5f5ea377/bridge-report.json`. The private source remains outside the public repository.
