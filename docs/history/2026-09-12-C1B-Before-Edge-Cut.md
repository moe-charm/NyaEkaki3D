...
更新: 2026-09-12。複数面dissolveをGUIへ接続。4面→1quad/拒否時選択保持/Undo/native/BakeとWindows suite成功。Core直近223件。
...
powershell -NoProfile -ExecutionPolicy Bypass -File .\Tools\Test-NyaForgeAuthoring.ps1 -BuildName Windows-C1B-Dissolve -Width 1280 -Height 800 -TimeoutSeconds 600
```
