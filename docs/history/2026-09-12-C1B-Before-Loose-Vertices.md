...
更新: 2026-09-12。順序付き面作成GUIを接続。輪郭/無効指定/作成/Undo/native/BakeをPlayerで確認。Core直近210件。最新PlayerはFaceCreation。
...
powershell -NoProfile -ExecutionPolicy Bypass -File .\Tools\Test-NyaForgeAuthoring.ps1 -BuildName Windows-C1B-FaceCreation -Width 1280 -Height 800 -TimeoutSeconds 600
```
