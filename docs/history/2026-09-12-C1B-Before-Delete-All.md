...
更新: 2026-09-12。空の形状から始めるGUI/面なし点表示を統合。0→3点→最初の面/保存/Undo/BakeとWindows suite成功。Core直近215件。
...
powershell -NoProfile -ExecutionPolicy Bypass -File .\Tools\Test-NyaForgeAuthoring.ps1 -BuildName Windows-C1B-EmptyPolygon -Width 1280 -Height 800 -TimeoutSeconds 600
```
