...
更新: 2026-09-12。新規頂点GUIと未接続点の編集表示/選択を実装。Core212件、Windows Player suite成功。
...
powershell -NoProfile -ExecutionPolicy Bypass -File .\Tools\Test-NyaForgeAuthoring.ps1 -BuildName Windows-C1B-LooseVertexCache -Width 1280 -Height 800 -TimeoutSeconds 600
```
