...
更新: 2026-09-12。辺上切断GUI/線preview/確定を実装。Windows suite成功。Core直近225件。
...
powershell -NoProfile -ExecutionPolicy Bypass -File .\Tools\Test-NyaForgeAuthoring.ps1 -BuildName Windows-C1B-EdgeCut -Width 1280 -Height 800 -TimeoutSeconds 600
```
