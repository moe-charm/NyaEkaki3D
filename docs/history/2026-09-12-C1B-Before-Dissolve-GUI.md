...
更新: 2026-09-12。複数面dissolveのCore/commandを追加、223件成功。GUIは未接続。最新PlayerはFacelessRecoveryEdit。
...
powershell -NoProfile -ExecutionPolicy Bypass -File .\Tools\Test-NyaForgeAuthoring.ps1 -BuildName Windows-C1B-FacelessRecoveryEdit -Width 1280 -Height 800 -TimeoutSeconds 600
```
