...
更新: 2026-09-12。頂点weldをGUIへ接続。成功後の選択更新/拒否時の状態保持/Undo/native/BakeをWindows Playerで確認。Core直近207件成功。
