...
更新: 2026-09-12。面なしpolygon正本/保存v3/最初の面作成をCoreで実装、214件成功。graph/GUI統合は次工程。最新PlayerはPointBatches。
