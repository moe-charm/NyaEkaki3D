...
更新: 2026-09-12。面なしpolygonをgraph/command/nativeへ統合、215件成功。GUI統合は次工程。最新確認済みPlayerはPointBatches。
