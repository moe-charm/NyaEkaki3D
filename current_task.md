...
- `SkinnedGeometryExtended`の8 influence writer→GLB再取込回帰を追加。Core **434 passed / 0 failed** (`C:/Users/tomoaki/AppData/Local/Temp/NyaForge-Core-Tests-bb5b61043ff545919312e45ac328c082`)。Windows Player build **PASS** (`Logs/build-player-20260913-025706-941.log`, `Builds/ExtendedGlbV1/NyaForge.exe`)、Authoring suite **PASS** (`Artifacts/Authoring-20260913-025733-6d8dccdbe10949f8baa277d967cdec8e/report.json`)。実Unity/VRChat受取先での拡張profile受入は未確認。
