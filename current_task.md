...
| [ ] I04-C / P1 **継続** | rig/weight/morph容量とcodec/hash/表示/出力 | nativeは512骨・32 influence・512 morphへ拡張し、257骨・18weight・単一mesh262morphの削減なし往復とGLB全JOINTS_n/WEIGHTS_n取込を回帰済み。標準SkinnedGeometryは互換上4 influenceを明示拒否するため、拡張skin出力profileと実受取側確認が残る |
