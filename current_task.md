...
- GLB normalized weight regression: Core **424 passed / 0 failed**（`Logs/core-normalized-weights-20260913.txt`、artifact `C:/Users/tomoaki/AppData/Local/Temp/NyaForge-Core-Tests-eb6a7e38d3384cca890db0cac98c4f30`）。source skin importerとskin importerでnormalized UBYTE weightをfloatへ復元し、既存のfloat形式と同じnormalized bindingになることを確認。
