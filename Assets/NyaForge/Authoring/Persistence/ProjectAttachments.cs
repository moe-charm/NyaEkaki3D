...
namespace NyaForge.Authoring
{
    ...
    public sealed class ProjectAttachments
    {
        ...
        public const string RigSessions = "imported-rig-sessions.nyaforge.bin";
        ...
        {
            Checks.Require(source != null && source.Count <= MaxCount, "INVALID_ATTACHMENT", "Expected at most eight owned project attachments.");
        ...
        {
            Checks.Require(name == Expressions || name == Springs || name == Rig || name == RigSessions || name == PhysBones || name == SecondaryMotion || name == ReferenceProtection || name == ImportDiagnostics, "INVALID_ATTACHMENT", "Unknown project attachment name.");
        }
    }
}
