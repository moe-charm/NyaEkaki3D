    ...
    public static class AuthoringReadService
    {
        public static JObject Read(AuthoringWorkspace workspace,string instance,string method)
        {
            ...
            return new JObject
            {
                ...
                ["remoteNodeTypes"]=new JArray(BuiltinNodes.Paint,BuiltinNodes.PolygonSource,BuiltinNodes.PolygonEdit,BuiltinNodes.AssignMaterials,BuiltinNodes.Plane,BuiltinNodes.EditMesh,BuiltinNodes.Output,BuiltinNodes.StandardMaterial,BuiltinNodes.AssignMaterial,BuiltinNodes.Skeleton,BuiltinNodes.Attachment),
