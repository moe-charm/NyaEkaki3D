...
namespace NyaForge.UnityRuntime
{
    public sealed partial class AuthoringWorkbench
    {
        ...
        void BuildModelImportSelection(VisualElement parent)
        {
            ...
            parent.Add(modelImportMeshIndex); parent.Add(modelImportSkinIndex);
        ...
        void InspectModelSelection(string path)
        {
            ...
            string instance = " instances " + inventory.Instances.Count;
            modelImportSelectionStatus.text = "候補: mesh " + meshIndex + " (" + mesh.Name + ", " + mesh.PrimitiveCount + " primitive) · skins " + inventory.Skins.Count + instance + " · source " + inventory.SourceHash.Substring(0, 12);
        }
