            ...
            try
            {
                ...
                switch (request.Profile)
                {
                    ...
                    case GlbExportProfile.SkinnedGeometry:
                        result = GlbExportService.ExportSkinned(workspace, pipeInstance, request.DocumentId, request.ExpectedRevision, directory, importedRigSession?.MeshInstanceTransform); break;
                    case GlbExportProfile.SkinnedGeometryExtended:
                        result = GlbExportService.ExportSkinnedExtended(workspace, pipeInstance, request.DocumentId, request.ExpectedRevision, directory, importedRigSession?.MeshInstanceTransform); break;
