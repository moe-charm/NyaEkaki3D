...
namespace NyaForge.UnityRuntime
{
    public sealed partial class AuthoringWorkbench
    {
        ...
        void BuildAttachments(VisualElement parent)
        {
            ...
            ConfigureWrappedChoice(attachmentTarget, "装着先のavatarを表示名と役割で選びます。完全な内部IDはtooltipに表示します。対象を変えるとBoneId候補も切り替わります。");
            ...
            ConfigureWrappedChoice(attachmentBone, "装着先avatarのstable BoneIdを選びます。表示名の後ろに短縮IDを表示し、完全なBoneIdはtooltipで確認できます。");
